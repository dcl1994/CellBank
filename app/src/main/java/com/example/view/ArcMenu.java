...
public class ArcMenu  extends ViewGroup implements OnClickListener{
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.ArrowRectangleView, defStyle, 0);

        int pos = a.getInt(R.styleable.ArrowRectangleView_position, POS_RIGHT_BOTTOM);
        switch (pos)
        {
            case POS_LEFT_TOP:
        ...
        mRadius = (int) a.getDimension(R.styleable.ArrowRectangleView_radius, TypedValue
